...
export PATH=/Library/Internet\ Plug-Ins/JavaAppletPlugin.plugin/Contents/Home/bin:/Applications/Postgres.app/Contents/Versions/9.3/bin:/usr/local/bin:/usr/bin:/usr/sbin:/sbin:/bin:/usr/local/share/npm/bin:/usr/local/sbin
